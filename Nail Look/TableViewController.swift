...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let op = images[indexPath[1]]
        cell.textLabel?.text = op.name
        cell.imageView?.image = UIImage(named: op.image)
        cell.imageView?.frame.size = CGSize(width: 133, height: 79)
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let imageOp = images[indexPath[1]]
        image = UIImage(named: imageOp.image)!
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let controller =  (segue.destination as! VisionObjectRecognitionViewController)
